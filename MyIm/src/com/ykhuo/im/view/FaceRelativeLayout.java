...
import com.ykhuo.im.adapter.FaceAdapter;
import com.ykhuo.im.adapter.ViewPagerAdapter;
import com.ykhuo.im.bean.ChatEmoji;
...
public class FaceRelativeLayout extends RelativeLayout implements
	...
	private ImageButton btn_emote,btn_voice,btn_jia;
	...
	public void onClick(View v) {
		...
		case R.id.chat_btn_emote:
			...
			if (view.getVisibility() == View.VISIBLE) {
				...
				btn_emote.setImageResource(R.drawable.ic_chat_emote_normal);
			} else {
				view.setVisibility(View.VISIBLE);
				btn_emote.setImageResource(R.drawable.ic_jianpan);
				//如果点击表情时，此时是语音状态，就切换
				recorder_button.setVisibility(View.GONE);
				et_sendmessage.setVisibility(View.VISIBLE);
				btn_voice.setImageResource(R.drawable.ic_publish_voice);
			}
			break;
		case R.id.chat_edit_input:
			...
			break;
		case R.id.chat_btn_voice: //如果点击的是语音按钮
			//改变语音图标
			if(recorder_button.getVisibility()==View.GONE){
				recorder_button.setVisibility(View.VISIBLE);
				et_sendmessage.setVisibility(View.GONE);
				btn_voice.setImageResource(R.drawable.ic_jianpan);
			}else{
				recorder_button.setVisibility(View.GONE);
				et_sendmessage.setVisibility(View.VISIBLE);
				btn_voice.setImageResource(R.drawable.ic_publish_voice);
		...
		case R.id.chat_btn_jia:
			// 隐藏功能设置盘
			if(chatSetting.getVisibility()==View.GONE){
				chatSetting.setVisibility(View.VISIBLE);
				btn_jia.setImageResource(R.drawable.jia_select);
			}else{
				chatSetting.setVisibility(View.GONE);
				btn_jia.setImageResource(R.drawable.ic_jiahao);
			}
			break;
	...
	private void Init_View() {
		...
		et_sendmessage = (EditText) findViewById(R.id.chat_edit_input);
		layout_point = (LinearLayout) findViewById(R.id.iv_image);
		btn_emote=(ImageButton)findViewById(R.id.chat_btn_emote);
		btn_voice=(ImageButton)findViewById(R.id.chat_btn_voice);
		btn_send=(Button)findViewById(R.id.chat_btn_send);
		btn_jia=(ImageButton)findViewById(R.id.chat_btn_jia);
		recorder_button=(AudioRecorderButton)findViewById(R.id.id_recorder_button);
		
		chatSetting=(LinearLayout) findViewById(R.id.chatSetting);
		//设置事件
		et_sendmessage.setOnClickListener(this);
		btn_emote.setOnClickListener(this);
		...
		et_sendmessage.addTextChangedListener(new TextWatcher() {
			...
			public void afterTextChanged(Editable s) {
				if(s.toString().equals("")){
					...
					btn_jia.setVisibility(View.GONE);
