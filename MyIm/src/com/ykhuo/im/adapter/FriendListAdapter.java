...
public class FriendListAdapter extends BaseAdapter {
	...
	public FriendListAdapter(Context context, List<User> vector) {
		...
		System.out.println("≥ı ºªØriendAdapter");
	}
	@Override
	public View getView(int position, View convertView, ViewGroup root) {
		...
		Bitmap photo = (ApplicationData.getInstance().getFriendPhotoMap()).get(user.getAccount());
		String name = user.getNickname()+"  ("+user.getUsername()+")";
